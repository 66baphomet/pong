...
//  top paddle mover
    ...
    if(ballX+ballRadius>canvas.width){ballDx=-3}
    ...
    else if(ballX-ballRadius<0){ballDx=3}
    ...
    if((ballX>=bottomX && ballX<=bottomX+paddleWidth/2) && ballY+ballRadius>=bottomY)
    {
        ballDy=-ballDy;
        ballDx=-3;
    }
    else if((ballX>=bottomX+paddleWidth/2 && ballX<=bottomX+paddleWidth) && ballY+ballRadius>=bottomY)
    {
        ballDy=-ballDy;
        ballDx=3;
    }

    if((ballX>=topX && ballX<=topX+paddleWidth/2) && ballY-ballRadius<=topY+paddleHeight)
    {
        ballDy=-ballDy;
        ballDx=-3;
    }
    else if((ballX>=topX+paddleWidth/2 && ballX<=topX+paddleWidth) && ballY-ballRadius<=topY+paddleHeight)
    {
        ballDy=-ballDy;
        ballDx=3;
    }
