...
//  bottom paddle mover
    if(bottomRightMove && bottomX+paddleWidth<=canvas.width+paddleWidth/2){bottomX+=Dx;}
    else if(bottomLeftMove && bottomX>=-paddleWidth/2){bottomX-=Dx;}
//  top paddle mover
    if(topRightMove && topX+paddleWidth<=canvas.width+paddleWidth/2){topX+=Dx;}
    else if(topLeftMove && topX>=-paddleWidth/2){topX-=Dx;}
